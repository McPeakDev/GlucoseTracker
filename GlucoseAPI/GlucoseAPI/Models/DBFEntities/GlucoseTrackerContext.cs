        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Login>(entity =>
            {
                ...
                entity.HasIndex(e => e.Email)
                    .HasName("Login_Email_uindex")
                    .IsUnique();

                entity.HasIndex(e => e.UserId)
                    .HasName("Login_UserID_uindex")
                    .IsUnique();
                ...
                entity.HasOne(d => d.EmailNavigation)
                    .WithOne(p => p.LoginEmailNavigation)
                    .HasPrincipalKey<User>(p => p.Email)
                    .HasForeignKey<Login>(d => d.Email)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("UserEmail___fk");

                entity.HasOne(d => d.User)
                    .WithOne(p => p.LoginUser)
                    .HasForeignKey<Login>(d => d.UserId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("UserID___fk");
            });
